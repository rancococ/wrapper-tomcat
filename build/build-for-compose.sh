...
fun_build() {
    ...
    #find "${build_home}/${product_name}" -print0 | xargs -0 touch
    #find "${build_home}/${product_name}" -type d -print0 | xargs -0 chmod 755
    #find "${build_home}/${product_name}" -type f -print0 | xargs -0 chmod 644
